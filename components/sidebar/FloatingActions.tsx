...
export function FloatingActions() {
  ...
  // Sync navOpen state when Navigation closes itself (close btn / link click)
  useEffect(() => {
  ...
  return (
    <>
      {/* MENU trigger — top-right corner, separate from bottom actions */}
      <button
        ref={menuBtnRef}
      ...
      {/* CONNECT + PROJECT — bottom-right corner */}
      ...
      {/* Sidebars — always in DOM, show/hide via GSAP */}
      <ConnectSidebar
        isOpen={connectOpen}

...
export function NotFoundScene() {
  ...
  // Signal ClientShell to hide FloatingActions; force dark html/body background
  useEffect(() => {
    setPage404(true);
  ...
  useEffect(() => {
    ...
    // Parallax layers — 404 moves with mouse, bg text moves against (depth)
  ...
  return (
    ...
    >
      {/* ── Layer 0 — canvas (scanlines + fragments) ── */}
      <div className="absolute inset-0 z-0">
        <PixelFragmentSystem />
      </div>

      {/* ── Layer 0 — oversized background "PIXELS" (depth) ── */}
      <div
        ref={bgTextRef}
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-6 py-16 md:py-24">
        ...
        {/* Giant 404 — overflow-hidden clips char reveal */}

...
/**
 * Canvas layer rendering scanlines, grid dots, and floating pixel fragments.
 * Automatically skips heavy rendering on touch/coarse-pointer devices.
 */
export function PixelFragmentSystem() {
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      // ~1 fragment per 16 000 px² — max 180

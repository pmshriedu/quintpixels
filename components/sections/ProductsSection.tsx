...
const PRODUCTS = [
  {
    ...
    desc: "A unified design-token and component system for teams building at scale.",
    Icon: Layers,
    status: "Available",
  },
  {
    ...
    desc: "Schema-first API gateway with automatic versioning and intelligent routing.",
    Icon: Network,
    status: "Beta",
  },
  {
    ...
    desc: "Visual workflow builder for engineering teams — no-code logic, full-code power.",
    Icon: Workflow,
    status: "Coming Soon",
  },
];

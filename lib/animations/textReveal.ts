...
/**
 * Reveal text line by line with a clip-path mask from bottom
 */
...
/**
 * Reveal characters with stagger (for display headings)
 */
...
/**
 * Fade + slide up reveal for generic elements
 */
...
/**
 * Animated line draw — scale X from 0 to 1
 */

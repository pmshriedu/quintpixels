...
/**
 * Orchestrated entrance timeline for the 404 page.
 * Returns a cleanup function that kills the timeline.
 */
...
/**
 * Schedules random GSAP glitch bursts on the 404 element.
 * Returns a cleanup that cancels the pending timeout.
 */
...
/**
 * Mouse-move parallax on multiple depth layers.
 * Positive strength moves WITH the mouse; negative moves AGAINST (counter-parallax).
 */

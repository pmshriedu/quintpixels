...
export default function RegisterClient() {
  ...
  return (
    ...
    >
      {/* Left panel */}
      <div className="hidden lg:flex flex-col justify-between w-[46%] p-12 border-r border-white/5 relative overflow-hidden">
        <div
          className="absolute inset-0 opacity-[0.07]"
          style={{
            backgroundImage: `linear-gradient(to right, rgba(11,11,10,0.5) 1px, transparent 1px), linear-gradient(to bottom, rgba(11,11,10,0.5) 1px, transparent 1px)`,
            backgroundSize: "40px 40px",
          }}
        />
        <div className="absolute top-[25%] right-[18%] w-2 h-2 bg-white/8" />
        <div className="absolute bottom-[35%] left-[20%] w-1.5 h-1.5 bg-white/6" />
        ...
        <div>
          <div className="font-pixel text-[10px] tracking-[0.3em] text-white/25 uppercase mb-4">
            NEW ACCESS
          </div>
          <h1 className="text-display-lg font-pixel text-white leading-none mb-5">
            JOIN THE
            <br />
          ...
          <form action={action} className="space-y-4">
            ...
            <div data-form-el className="pt-2">
              <button
                type="submit"
                disabled={pending}
                className="w-full bg-white text-black font-pixel text-[9px] tracking-widest uppercase py-3.5 rounded-sm hover:bg-white/90 transition-colors disabled:opacity-50"
              >

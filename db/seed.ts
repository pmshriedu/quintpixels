  ...
  const productData = [
    {
      ...
      description:
        "Our internal deployment and infrastructure orchestration platform, now available as a managed service. Ship faster with zero-config CI/CD, preview environments, and automated rollbacks.",
      icon: "Layers",
      status: "Available",
      learnMoreUrl: "/products/pixelos",
      order: 0,
    },
    {
      productId: "P-002",
      ...
      type: "API Gateway",
      description:
        "A high-performance API gateway designed for modern microservice architectures. Rate limiting, authentication, caching, and observability out of the box.",
      icon: "Network",
      status: "Beta",
      learnMoreUrl: "/products/mesh",
      order: 1,
    },
    {
      productId: "P-003",
      ...
      description:
        "Visual workflow builder for complex business processes. Connect any API, trigger actions on events, and monitor execution in real-time — no code required.",
      icon: "Workflow",
      status: "Coming Soon",
      learnMoreUrl: "/products/flowkit",
      order: 2,
    },
  ];
